...
# 1.3 Почему количество документов меньше количества вхождений? Ответ: потому что в одном документе одно слово может встречаться несколько раз
...
```
# 3.4 Ответ: так как данная строка рассчитана на ввод единичной лексемы в словарной форме
```
...
```
# 5.1 Объем снятника: Найдено 2 170 документов общим объемом 519 725 предложений, 6 003 398 слов.
```
